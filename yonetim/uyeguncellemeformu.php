...
echo '<form action="labrntlist.php?id='.$guncelleid.'" method="post" name="form">
...
<td colspan="2"><div align="right"> <a href=labrntekle.php>Listeye Dön</a> <input type="reset" value="Geri Al">&nbsp;&nbsp;<input type="submit" value="Güncelle" />&nbsp;</div></td>
</tr>
</table>
</form>';
