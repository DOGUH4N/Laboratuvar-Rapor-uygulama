...
<head>
    ...
    <meta charset="utf-8">
      <!-- yönlendirme -->
<meta http-equiv="refresh" content="5;URL=giris.php">
<!-- yönlendirme -->
    </head>
    <body>
        <font face="arial">
...
if($_POST)
     ...
     {
          echo 'Başarıyla Üye Oldunuz. <br> <a href="giris.php">Giriş Sayfasına Dön</a>';
          
          }
          else 
          {
               echo 'Hata! Üye Olamadınız. <br> <a href="giris.php">Giriş Sayfasına Dön</a>';
               }

          } else {

            echo '<br><br> <h2>Laboratuvarın size verdiği hesap oluşturabilme<br>yetki kodunu yanlış girdiniz.</h2> <br>';
          }
